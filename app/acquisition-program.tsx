...
const LANDING_STEPS = [
  ...
  },
  {
    ...
    body: 'You are considered a Brand Ambassador for NumVault. Share your referral code with people, each person just needs to sign up and make one purchase for our system to confirm them as your customer. Your first 76 confirmed customers show us that you are reliable and ready to represent our company. Once we see that, we officially bring you on as a Customer Acquisition Lead and set up your Staff Dashboard. We will ask for your Nigerian bank account number, no card details, nothing else, and we use Paystack, our payments processor, to transfer your earnings directly to your account. From that point, every 76 paying customers you refer in a month earns you ₦100,000 paid straight to your bank. We do this for six months. Expect a bank transfer from Paystack each time you hit your target. We would be excited to have you on board with our company.',
  },
];
